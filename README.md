...
| **[Full Compendium](https://raw.githubusercontent.com/6x4r8dxnxp/offshore-hvdc-2-GW-MMC-VSC-compendium/main/Compendium_2GW_MMC-VSC.pdf)** | 77 | HVDC engineers, TSOs | Technical deep-dive with mathematical annex |
...
- **HVDC Engineers** - Detailed technical specifications and mathematical models
- **Transmission System Operators (TSOs)** - Operational frameworks and governance structures
- **Policy Makers** - Strategic context and European grid integration
- **Project Developers** - Platform engineering principles for offshore wind

## 🔌 Technical Scope

This compendium covers:
- ⚡ **Modular Multilevel Converter (MMC)** technology
- 🔄 **Voltage Source Converter (VSC)** systems
- 🌊 **Offshore-to-mainland transmission corridors**
- 🇪🇺 **ENTSO-E** integration frameworks
- 📊 **Systems engineering** methodologies
- 🛠️ **Platform engineering** approaches

## 📖 Contents Overview

### Research Brief
Strategic overview for decision-makers:
- Core principles of 2-GW platform standardization
- European offshore corridor framework
...
`HVDC` • `MMC-VSC` • `Offshore Wind` • `Transmission` • `Systems Engineering` • `TSO` • `ENTSO-E` • `Platform Engineering` • `CIGRE` • `Evidence-Based`

## 👤 Author & Contact

**Enno Boettcher**
- 💼 [LinkedIn Profile](https://www.linkedin.com/in/enno-boettcher-2405eb)
